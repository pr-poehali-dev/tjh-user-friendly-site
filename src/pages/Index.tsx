...
type Section = "home" | "about" | "services" | "cabinet" | "meters" | "payments" | "documents" | "contacts";
...
export default function Index() {
  ...
  const [meterValues, setMeterValues] = useState({ cold: "", hot: "", electric: "", gas: "" });
  const [meterSent, setMeterSent] = useState(false);
  const [loginData, setLoginData] = useState({ flat: "", password: "" });
